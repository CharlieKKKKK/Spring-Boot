...
public interface UserService {
  ...
  List<com.vtxlab.bootcamp.bootcampsbforum.entity.User> getAllByEmailOrPhone(String email, String phone, Sort sort);

  List<com.vtxlab.bootcamp.bootcampsbforum.entity.User> getUsersByAddrLatGreaterThan(Double latitude);
