...
public class UserJsonPlaceHolder implements UserService {
  ...
  @Override
  public List<com.vtxlab.bootcamp.bootcampsbforum.entity.User> getAllByEmailOrPhone(String email, String phone,
      Sort sort) {
  ...
  @Override
  public List<com.vtxlab.bootcamp.bootcampsbforum.entity.User> getUsersByAddrLatGreaterThan(Double latitude) {
